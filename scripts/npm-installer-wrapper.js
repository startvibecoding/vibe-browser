...
// When installed via `npm i -g vibe-browser`, this script finds the
...
const PLATFORM_MAP = {
  'linux-x64-glibc': 'vibe-browser-linux-x64',
  'linux-arm64-glibc': 'vibe-browser-linux-arm64',
  'linux-x64-musl': 'vibe-browser-linux-musl-x64',
  'linux-arm64-musl': 'vibe-browser-linux-musl-arm64',
  'darwin-x64': 'vibe-browser-darwin-x64',
  'darwin-arm64': 'vibe-browser-darwin-arm64',
  'win32-x64': 'vibe-browser-win32-x64',
  'win32-arm64': 'vibe-browser-win32-arm64',
};
...
function findBinary() {
  ...
  console.error('  npm install -g vibe-browser');
  console.error('');
